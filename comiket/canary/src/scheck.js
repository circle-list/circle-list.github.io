...
function serverBackup(u, d) {
    $.ajax({
        url:'https://sp-wtr-api.gq/api/v1/circlelist/backup',
        type:'POST',
        data: {
            uuid: u,
            data: d
...
// TD;TR
// バックアップ処理はほとんど終わったはずなので、インポート処理&サーバー側処理を書くこと。
// また、バックアップ済みか否か（またバックアップしてあったらいつバックアップしたか）を見れるようにする（小さいボタンをつける）